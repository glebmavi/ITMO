...
ls -lR > res_3
wc -m */*o *o 2>/tmp/$$| sort -r >> res_4
ls -lR 2>&1| grep "se" | head -n4 | sort -k9 >> res_4
cat -n m* */m* | sort >> res_4
wc -m ./machoke2/* 2>/dev/null | sort -r >> res_4
ls -Rl | grep e$ | sort -k5r >> res_4
cat -n *t */*t 2>&1 | sort >> res_4
rm -f nosepass1
